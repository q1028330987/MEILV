...
<article class="page-container">
	<form action="<?php echo U('editor');?>" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" placeholder="" id="mobile" name="pass">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" placeholder="" id="mobile" name="pass2">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="sex" type="radio" id="sex-1" checked value = "2">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="businessman" type="radio" id="sex-1" checked value = '1'>
					<label for="sex-1">商户</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="businessman" value='2'>
					<label for="sex-2">普通用户</label>
				</div>
			</div>
		</div>
