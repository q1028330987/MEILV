...
<h3>添加友情链接</h3>
	<form class="form form-horizontal" id="form-admin-add" action='<?php echo U("Friend/listAdd");?>' method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="off"  placeholder="" id="password" name="address">
			</div>
		</div>
