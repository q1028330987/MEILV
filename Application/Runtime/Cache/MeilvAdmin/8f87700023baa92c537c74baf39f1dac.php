...
<article class="page-container">
	<form action="<?php echo U('User/change_password');?>?id=<?php echo ($list["id"]); ?>" method="post" class="form form-horizontal" id="form-change-password">	

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账户：</label>
			<div class="formControls col-xs-8 col-sm-9"> <?php echo ($list["name"]); ?> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" autocomplete="off" placeholder="不修改请留空" name="pass2" id="new-password2">
			</div>
		</div>
		<div class="row cl">
