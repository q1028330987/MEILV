...
<div class="account-cont clearfix">
    ...
    <div class="user-info clearfix ct-commonblack">
      <form class="form-horizontal" action="javascript:;">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <p class="form-control-static"><?php echo ($_SESSION['userinfo']['name']); ?></p>
          </div>
  ...
  <script>
      ...
      $('button').on('click',function() {
        ...
        $.post('<?php echo U("Out/userPass");?>',{pass:pass},function (data){
          	...
          	if(data ==1){
          		...
          		location.href ='<?php echo U("Login/LoginExtends");?>';
