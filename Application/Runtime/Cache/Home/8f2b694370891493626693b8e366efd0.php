...
<div class="orders-tab fl">
  ...
  <span href="javascript:;" class="tab">
    ...
    <ul>
      <li><a href="<?php echo U('Orders/saleOrders');?>" class="borderradius-1 my-account active">店内订单</a></li>
  ...
  <div class="setting-box" id="setting-box">
        ...
        <?php if($info == false): ?><span style="font-size: 16px;">您还没有开通店铺<a class="" href="<?php echo U('ManStore/storeApplication');?>">立即申请</a></span>
        <?php else: ?>
            <?php echo ($info); endif; ?>
  </div>
</div>
