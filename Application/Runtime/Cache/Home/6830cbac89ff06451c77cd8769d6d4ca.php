...
<div class="account-cont clearfix">
  ...
  <span href="javascript:;" class="tab">
    ...
    <ul>
      <li><a href="<?php echo U('User/userInfo');?>" class="borderradius-1 my-account active">我的账号</a></li>
 ...
 <div class="setting-box" id="setting-box">
    <div class="user-info clearfix ct-commonblack">
      <i class="icon i-user-circle"></i>    
      <span class="source-label fl">用户名：<?php echo ($list["name"]); ?></span>
      <a href="<?php echo U('User/saveUserName');?>?id=<?php echo ($list["id"]); ?>" target="" class="s-btn j-modify-info"><span class="s-btn">修改用户名</span></a>
      <!-- <a href="<?php echo U('User/saveUser');?>" target="" class="s-btn j-modify-info"><span class="s-btn">修改账户信息</span></a> -->
    </div>
    <div class="user-info clearfix ct-commonblack">
      <span class="source-label fl">手机号：<?php echo ($list["phone"]); ?></span>
      <a href="<?php echo U('User/savePhone');?>" target="" class="s-btn j-modify-info"><span class="s-btn">修改手机号</span></a>
    </div>

    <div class="user-info clearfix ct-commonblack">
      <span class="source-label fl">密　码：******</span>
      <a href="<?php echo U('Out/userPass');?>" target="" class="s-btn j-modify-info"><span class="s-btn">修改密码</span></a>
    </div>
  </div>
</div>
      </div>
